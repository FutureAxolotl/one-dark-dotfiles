...
if len(sys.argv) <= 2:
    try:
        ...
        active_text_color = "#61afef"
        active_underline = "61afef" if underline is not False else None
        inactive_text_color = "#abb2bf"
        inactive_underline = "#abb2bf" if underline is not False else None
